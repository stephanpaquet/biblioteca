        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div v-if="showSummary">
                <p class="text-sm text-gray-700">
                    Showing <span class="font-medium">{{ pagination.startIndex + 1 }}</span> to <span class="font-medium">{{ pagination.endIndex }}</span> of <span class="font-medium">{{ pagination.totalItems.toLocaleString() }}</span> results
                </p>
            </div>
            <div>
