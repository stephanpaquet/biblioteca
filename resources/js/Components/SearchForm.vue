...
<template>
    <form @submit.prevent="handleSearch" class="w-full max-w-4xl mx-auto">
        ...
        <div class="relative mb-4">
            <input v-model="searchQuery" type="text" :placeholder="currentPlaceholder"
                ...
                :class="{ 'bg-gray-50': isLoading }" :disabled="isLoading" />
        ...
        <div v-if="showAdvanced" class="mt-4 p-4 bg-gray-50 rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input v-model="filters.publishedAfter" type="number" min="1000" max="2024" placeholder="e.g., 2000"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Published Before</label>
                    <input v-model="filters.publishedBefore" type="number" min="1000" max="2024"
                ...
                <div>
                    ...
                    <select v-model="filters.printType"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select v-model="filters.maxResults"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
